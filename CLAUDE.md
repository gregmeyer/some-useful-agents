...
## Docs map
- **User-facing docs**: [docs/](docs/) — quickstart, agents, flows, llm-providers, tools, mcp, integrations, output-widgets, templating, dashboard, build-from-goal, inbox-control-plane, outcome-detection, temporal, security
