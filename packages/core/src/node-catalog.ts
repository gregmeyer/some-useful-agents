...
export const NODE_CATALOG: Record<NodeType, NodeContract> = {
  ...
  'llm-prompt': {
    ...
    inputs: [
      ...
      { name: 'tools', type: 'string[]', description: 'Builtin tool ids the model may CALL mid-generation under an OpenAI-compatible provider (e.g. web-scrape, web-fetch, http-get). Up to maxTurns turns.' },
